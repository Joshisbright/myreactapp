...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        className="min-h-screen pt-32 pb-24 relative overflow-hidden flex items-center bg-[#1A1A1A]"
        ref={heroRef}
      >
        ...
        <div
          className="absolute top-1/4 -left-20 w-[300px] h-[300px] rounded-full bg-purple/10 filter blur-[100px] animate-pulse parallax-element"
          data-speed="0.05"
        ></div>
        <div
          className="absolute bottom-1/4 -right-20 w-[350px] h-[350px] rounded-full bg-purple/5 filter blur-[120px] animate-pulse parallax-element"
          data-speed="0.08"
          ...
          <div className="flex flex-col max-w-5xl mx-auto">
            <div className="fade-in">
              ...
              <h1 className="font-poppins text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8 text-white tracking-wider">
                Is Your Procurement{" "}
                <span className="relative inline-block text-purple neon-glow">
                  Chaos
                  <span className="absolute bottom-1 left-0 w-full h-[2px] bg-purple/30"></span>
                </span>{" "}
                <br className="hidden md:block" />
                Stalling Your Dreams?
              </h1>

              <p className="text-xl mb-10 text-white/90 font-inter max-w-2xl leading-relaxed">
                Every delay, every hidden cost, every unreliable supplier—eating
                away at your growth. Isn't it time your business broke free from
      ...
      <section
        id="services-section"
        className="py-section bg-[#121212] relative"
      >
        <div className="absolute inset-0 bg-grid z-0"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-20">
            <p className="text-[#9D4EDD] font-medium font-poppins tracking-wider mb-4">
            ...
            <p className="text-white/70 max-w-2xl mx-auto font-inter">
              Ad Maiora provides exclusive procurement consulting services
              designed to elevate Indian SMEs with unmatched supplier
              connections and strategic insights.
            </p>
          </div>
              ...
              <div className="group">
                <Card className="modern-card h-full border-[#333333] hover:border-[#9D4EDD]/30 overflow-visible">
                  ...
                  <CardContent className="p-8">
                    <h3 className="text-xl md:text-2xl font-poppins font-bold mb-4 text-white group-hover:text-[#9D4EDD] transition-colors duration-300">
                      Find Elite Suppliers
                    </h3>
                    <p className="text-white/70 font-inter leading-relaxed mb-6">
                      Connect with our exclusive network of trusted vendors
                      perfectly tailored to your unique business needs and
                      quality standards.
                    </p>
                    <Link href="/services">
              ...
              <div className="group">
                <Card className="modern-card h-full border-[#333333] hover:border-[#9D4EDD]/30 overflow-visible">
                  ...
                  <CardContent className="p-8">
                    ...
                    <p className="text-white/70 font-inter leading-relaxed mb-6">
                      Receive meticulously crafted supplier reports with
                      exclusive industry insights and strategic recommendations
              ...
              <div className="group">
                <Card className="modern-card h-full border-[#333333] hover:border-[#9D4EDD]/30 overflow-visible">
                  ...
                  <CardContent className="p-8">
                    ...
                    <p className="text-white/70 font-inter leading-relaxed mb-6">
                      Experience seamless deal coordination with our bespoke
                      service handling every aspect of negotiations, contracts,
